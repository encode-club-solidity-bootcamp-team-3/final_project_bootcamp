...
export interface Lottery extends BaseContract {
  ...
  closeLottery: TypedContractMethod<
    [tokenId: BigNumberish],
    [void],
    "nonpayable"
  >;

  getPrize: TypedContractMethod<[account: AddressLike], [bigint], "view">;
  ...
  purchaseTokens: TypedContractMethod<[value: BigNumberish], [void], "payable">;
